...
const RESERVATIONS_APP_URL = new URL("./modulos/checkin/index.html?mode=reservas&embed=system&build=20260811-11", window.location.href).href;
const CHECKIN_APP_URL = new URL("./modulos/checkin/index.html?mode=checkin&embed=system&build=20260811-11", window.location.href).href;
const BEVERAGE_APP_URL = new URL("./modulos/bebidas/index.html?embed=system&build=20260811-8", window.location.href).href;
const BEVERAGE_CATALOG_APP_URL = new URL("./modulos/bebidas/index.html?view=catalog&build=20260811-8", window.location.href).href;
